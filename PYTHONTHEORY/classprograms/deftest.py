baseprice,discount,scdis,dhike,evehike,afhike = 4000,50,15,25,30,10 #with def function
day = str(input("Enter day of movie:\n"))
age = int(input("Enter your age:\n"))
time = str(input("Enter movie timing:\n"))
def ticketprice (baseprice,day,time,age):
     ...
     return baseprice
baseprice = ticketprice(baseprice,day,time,age)
